...
const defaultValue: Toast = { isShow: false, showToast: noop, hideToast: noop, message: '', updateMessage: noop, duration: 5000, updateDuration: noop }
...
export const ToastProvider: React.FC = ({ children }) => {
  const [state, dispatch] = useReducer(toastReducer, { isShow: false, message: '', duration: 5000 })
  console.log(state)
  ...
  return <ToastContext.Provider value={{ ...defaultValue, isShow: state.isShow, showToast, hideToast, message: state.message, updateMessage, updateDuration }}>
    {children}
